...
from routers import auth_router, book_router, ai_router, category_router, user_router, progress_router, recommendation_router, forum_router, study_groups_router, chat_router
