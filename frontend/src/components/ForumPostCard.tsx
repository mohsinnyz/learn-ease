        ...
        <div className="flex-grow min-w-0 pb-3">
          ...
          <div className="prose prose-sm prose-slate dark:prose-invert max-w-none text-slate-800 dark:text-slate-300 leading-relaxed">
             <ReactMarkdown 
               ...
               components={{
                 // Custom Link Styling for Replies
                 a: ({node, ...props}) => (
                   <a 
                     target="_blank" 
                     rel="noopener noreferrer" 
                     className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline decoration-blue-300 dark:decoration-blue-500 hover:decoration-blue-800 dark:hover:decoration-blue-300 transition-all font-medium" 
                     {...props} 
                   />
                 )
               }}
