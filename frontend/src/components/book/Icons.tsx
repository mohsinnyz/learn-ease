// frontend/src/components/book/Icons.tsx
...
export const LayersIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.115 5.19l.319 1.913A6 6 0 0012 12h0a6 6 0 005.566-4.897l.319-1.913A2.25 2.25 0 0015.385 3H8.615a2.25 2.25 0 00-2.5 2.19zM12 12v3.75A2.25 2.25 0 019.75 18h-3.375a2.25 2.25 0 01-2.25-2.25V12h10.5zM12 12h3.75a2.25 2.25 0 012.25 2.25V18h-3.375a2.25 2.25 0 01-2.25-2.25V12z"
    />
  </svg>
);
...
export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.354a15.054 15.054 0 01-4.5 0M12 3v2.25m0 0c-1.406 0-2.731.46-3.75 1.244S6.75 8.219 6.75 9.75V12m10.5-2.25V9.75c0-1.531-.75-2.756-1.75-3.506S13.406 5.25 12 5.25M12 3c2.975 0 5.625 1.244 7.5 3.219"
    />
  </svg>
);
...
export const ArrowsRightLeftIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7.5 21 3 16.5m0 0 4.5-4.5M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5"
    />
  </svg>
);
