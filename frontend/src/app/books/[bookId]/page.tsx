...
  const [showQnAModal, setShowQnAModal] = useState(false);
 ...
 /* 
  useEffect(() => {
    if (glossaryData) {
      console.log(`Glossary data for page ${currentPageInView}:`, glossaryData);
    }
  }, [glossaryData, currentPageInView]);
*/
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-row gap-6">
        ...
        {/* Glossary Panel (Left) */}
        <aside className="w-72 min-w-[16rem] max-w-xs h-fit sticky top-6 self-start">
